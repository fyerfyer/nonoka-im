...
func (x *Packet) GetReadReceipt() *ReadReceipt {
	if x != nil {
		if x, ok := x.Payload.(*Packet_ReadReceipt); ok {
...
func (x *Packet) GetDeliveryReceipt() *DeliveryReceipt {
	if x != nil {
		if x, ok := x.Payload.(*Packet_DeliveryReceipt); ok {
...
type Packet_ReadReceipt struct {
	// CMD_READ_RECEIPT
	ReadReceipt *ReadReceipt `protobuf:"bytes,60,opt,name=read_receipt,json=readReceipt,proto3,oneof"`
}

type Packet_DeliveryReceipt struct {
...
type ReadReceipt struct {
	...
	UpToSeq       uint64                 `protobuf:"varint,2,opt,name=up_to_seq,json=upToSeq,proto3" json:"up_to_seq,omitempty"`  // messages with seq <= up_to_seq are marked as read
	ReaderId      int64                  `protobuf:"varint,3,opt,name=reader_id,json=readerId,proto3" json:"reader_id,omitempty"` // who read the messages
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ReadReceipt) Reset() {
	*x = ReadReceipt{}
	mi := &file_im_v1_packet_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReadReceipt) Descriptor() ([]byte, []int) {
	return file_im_v1_packet_proto_rawDescGZIP(), []int{5}
}

func (x *ReadReceipt) GetTopic() string {
	if x != nil {
		return x.Topic
	}
	return ""
...
func (x *ReadReceipt) GetUpToSeq() uint64 {
	if x != nil {
		return x.UpToSeq
	}
	return 0
...
func (x *ReadReceipt) GetReaderId() int64 {
	if x != nil {
		return x.ReaderId
	}
	return 0
...
func (x *DeliveryReceipt) Reset() {
	*x = DeliveryReceipt{}
	mi := &file_im_v1_packet_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeliveryReceipt) Descriptor() ([]byte, []int) {
	return file_im_v1_packet_proto_rawDescGZIP(), []int{6}
}

func (x *DeliveryReceipt) GetTopic() string {
	if x != nil {
		return x.Topic
	}
	return ""
...
func (x *DeliveryReceipt) GetTopicSeq() uint64 {
	if x != nil {
		return x.TopicSeq
	}
	return 0
...
func (x *DeliveryReceipt) GetMsgId() int64 {
	if x != nil {
		return x.MsgId
	}
	return 0
...
const file_im_v1_packet_proto_rawDesc = "" +
	...
	"\x0eretry_after_ms\x18\x04 \x01(\x04R\fretryAfterMs\"\\\n" +
	"\vReadReceipt\x12\x14\n" +
	"\x05topic\x18\x01 \x01(\tR\x05topic\x12\x1a\n" +
	"\tup_to_seq\x18\x02 \x01(\x04R\aupToSeq\x12\x1b\n" +
	"\treader_id\x18\x03 \x01(\x03R\breaderId\"[\n" +

...
const (
	FileService_UploadFile_FullMethodName   = "/api.im.v1.FileService/UploadFile"
	FileService_DownloadFile_FullMethodName = "/api.im.v1.FileService/DownloadFile"
)
...
func (c *fileServiceClient) UploadFile(ctx context.Context, in *UploadFileRequest, opts ...grpc.CallOption) (*UploadFileReply, error) {
...
func (UnimplementedFileServiceServer) UploadFile(context.Context, *UploadFileRequest) (*UploadFileReply, error) {
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.im.v1.FileService",
